    ...
    return(
        <div>
            <div className="px-9 md:px-22 w-full">
                ...
                <div className="grid grid-cols-3 gap-x-5 mt-20">
                    <div className="bg-[var(--colour-grey)] px-10 py-7 rounded-2xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-5 mt-8">
                    <div>
                        <div className="mb-5 bg-[var(--colour-grey)] px-10 py-7 rounded-2xl">
                ...
                <div className="grid grid-cols-[3fr_1fr] bg-transparent gap-x-1 gap-y-15 px-35">
                    <div className="h-full flex flex-col justify-center rounded-2xl bg-[var(--colour-grey)] px-13">
                ...
                <p className="text-2xl font-semibold text-[var(--colour-bodytext)] mt-30 mb-8">First prototype</p>
                ...
                <div className="mt-20">
                    <p className="text-md text-[var(--colour-bodytext)] font-semibold">Next up, I conducted in-person user testing with 2 users.</p>
