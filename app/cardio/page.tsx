        ...
        <div>
            <div className="px-9 md:px-22 w-full">
                ...
                <div>
                    ...
                    <div className="flex flex-col items-center justify-center bg-[var(--colour-grey)] px-10 py-7 rounded-2xl">
                        {/* <div className="text-center mt-1 mb-2">
                            <p className="text-sm text-[var(--colour-darkgrey)]">Click on each video to expand.</p>
                        </div> */}
                        <div className="grid grid-cols-4 mt-3 mb-3 gap-x-4 w-3/5">
                ...
                <div className="grid grid-cols-[2fr_1fr] gap-y-15 px-35">
