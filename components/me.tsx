...
export default function Me() {
    return (
        <div className="relative group">
            ...
            <p className="absolute transition-all duration-800 ease-in-out text-[var(--main-blue)] font-medium tracking-tight text-[10rem] -bottom-34 right-6 group-hover:-bottom-38 group-hover:right-9">*</p>
        </div>
    )
}
